<?php
	...
	$query = $conn->prepare('SELECT d.id AS departmentID, d.name AS departmentName, l.id AS locationID, l.name AS locationName FROM department d LEFT JOIN location l ON d.locationID = l.id WHERE d.locationID = ?');
